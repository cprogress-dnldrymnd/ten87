...
if ( $max_value && $min_value === $max_value ) {
	...
	$label =  esc_html__( 'Quantity', 'obsius' );
	?>
	<div class="qodef-quantity-buttons quantity">
		...
		<div class="qodef-quantity-buttons-holder">
			...
			<input
				type="<?php echo esc_attr( apply_filters( 'obsius_filter_woo_quantity_input_type', 'text' ) ); ?>"
				...
				title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'obsius' ); ?>"
				size="4"
